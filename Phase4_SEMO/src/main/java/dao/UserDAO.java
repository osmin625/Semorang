...
public class UserDAO {
	...
	public int valid_login(String id, String pw) {
		...
		try {
			...
			System.err.println("UserDAO : valid_login 오류");
			e.printStackTrace();
		}
		finally {
...
//	
//	public boolean insert(String user_id, String password, String name, String region, String phone_number) throws SQLException{
